// CamillaDSP-Monitor: ConvolutionFilter correctness tests.
//
// Migrated from CamillaDSP-Swift's `ConvolutionTests.swift` (XCTest) to
// swift-testing, and adapted to the Monitor's `ConvolutionFilter`
// constructor (`init(name:coefficients:chunkSize:)` for direct IR
// arrays, plus the convenience `ConvParameters` initialiser for the
// filesystem path).
