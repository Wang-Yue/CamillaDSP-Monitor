...
TEST(compressor_basic_compression) {
    ...
    compressor_processor_t* comp = compressor_processor_create("compressor", &params, 48000, 1000);
...
TEST(noisegate_basic_gate) {
    ...
    noise_gate_processor_t* gate = noise_gate_processor_create("noisegate", &params, 48000, 100);
