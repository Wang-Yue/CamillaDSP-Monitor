...
TEST(ProcessingParametersUpdateLevels) {
    ...
    double loudest_cap = processing_parameters_update_capture_levels(params, chunk);
    ...
    double loudest_pb = processing_parameters_update_playback_levels(params, chunk);
