...
enum CoreAudioDevice {
  ...
  @discardableResult
  static func setBufferFrameSize(_ deviceID: AudioDeviceID, _ frames: UInt32, scope: CoreAudioScope)
    -> Bool
  {
    var addr = AudioObjectPropertyAddress(
  ...
  static func bufferFrameSize(_ deviceID: AudioDeviceID, scope: CoreAudioScope) -> UInt32? {
    var addr = AudioObjectPropertyAddress(
      mSelector: kAudioDevicePropertyBufferFrameSize,
      mScope: scope.streamScope,
      mElement: kAudioObjectPropertyElementMain
