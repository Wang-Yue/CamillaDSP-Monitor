...
static resampler_error_t sync_process(audio_resampler_t* self, const audio_chunk_t* input, audio_chunk_t* output) {
    return synchronous_resampler_process((synchronous_resampler_t*)self->impl, input, output);
}
static void sync_set_ratio(audio_resampler_t* self, double mult) {
    synchronous_resampler_set_relative_ratio((synchronous_resampler_t*)self->impl, mult);
}
static double sync_get_ratio(const audio_resampler_t* self) {
    return synchronous_resampler_get_ratio((const synchronous_resampler_t*)self->impl);
}
static size_t sync_get_max(const audio_resampler_t* self) {
    return synchronous_resampler_get_max_output_frames((const synchronous_resampler_t*)self->impl);
}
static size_t sync_get_cs(const audio_resampler_t* self) {
    return synchronous_resampler_get_chunk_size((const synchronous_resampler_t*)self->impl);
}
static size_t sync_get_ch(const audio_resampler_t* self) {
    return synchronous_resampler_get_channels((const synchronous_resampler_t*)self->impl);
}
static void sync_free(audio_resampler_t* self) {
    if (self->impl) synchronous_resampler_free((synchronous_resampler_t*)self->impl);
    free(self);
}

audio_resampler_t* audio_resampler_wrap_synchronous(synchronous_resampler_t* res) {
    if (!res) return NULL;
    audio_resampler_t* wrap = (audio_resampler_t*)calloc(1, sizeof(audio_resampler_t));
    if (!wrap) {
...
static resampler_error_t sinc_process(audio_resampler_t* self, const audio_chunk_t* input, audio_chunk_t* output) {
    return async_sinc_resampler_process((async_sinc_resampler_t*)self->impl, input, output);
}
static void sinc_set_ratio(audio_resampler_t* self, double mult) {
    async_sinc_resampler_set_relative_ratio((async_sinc_resampler_t*)self->impl, mult);
}
static double sinc_get_ratio(const audio_resampler_t* self) {
    return async_sinc_resampler_get_ratio((const async_sinc_resampler_t*)self->impl);
}
static size_t sinc_get_max(const audio_resampler_t* self) {
    return async_sinc_resampler_get_max_output_frames((const async_sinc_resampler_t*)self->impl);
}
static size_t sinc_get_cs(const audio_resampler_t* self) {
    return async_sinc_resampler_get_chunk_size((const async_sinc_resampler_t*)self->impl);
}
static size_t sinc_get_ch(const audio_resampler_t* self) {
    return async_sinc_resampler_get_channels((const async_sinc_resampler_t*)self->impl);
}
static void sinc_free(audio_resampler_t* self) {
    if (self->impl) async_sinc_resampler_free((async_sinc_resampler_t*)self->impl);
    free(self);
}
...
static resampler_error_t poly_process(audio_resampler_t* self, const audio_chunk_t* input, audio_chunk_t* output) {
    return async_poly_resampler_process((async_poly_resampler_t*)self->impl, input, output);
}
static void poly_set_ratio(audio_resampler_t* self, double mult) {
    async_poly_resampler_set_relative_ratio((async_poly_resampler_t*)self->impl, mult);
}
static double poly_get_ratio(const audio_resampler_t* self) {
    return async_poly_resampler_get_ratio((const async_poly_resampler_t*)self->impl);
}
static size_t poly_get_max(const audio_resampler_t* self) {
    return async_poly_resampler_get_max_output_frames((const async_poly_resampler_t*)self->impl);
}
static size_t poly_get_cs(const audio_resampler_t* self) {
    return async_poly_resampler_get_chunk_size((const async_poly_resampler_t*)self->impl);
}
static size_t poly_get_ch(const audio_resampler_t* self) {
    return async_poly_resampler_get_channels((const async_poly_resampler_t*)self->impl);
}
static void poly_free(audio_resampler_t* self) {
    if (self->impl) async_poly_resampler_free((async_poly_resampler_t*)self->impl);
    free(self);
}
...
static size_t apple_get_max(const audio_resampler_t* self) {
    return apple_resampler_get_max_output_frames((const apple_resampler_t*)self->impl);
}
...
audio_resampler_t* audio_resampler_create_from_config(const resampler_config_t* config, size_t input_rate, size_t output_rate, size_t channels, size_t chunk_size) {
    ...
    switch (config->type) {
        case RESAMPLER_TYPE_SYNCHRONOUS: {
            synchronous_resampler_t* res = synchronous_resampler_create(channels, input_rate, output_rate, chunk_size);
            return audio_resampler_wrap_synchronous(res);
        }
        case RESAMPLER_TYPE_ASYNC_SINC: {
            if (config->has_sinc_len && config->has_oversampling_factor && config->has_window && config->has_interpolation) {
                window_function_t wf = window_function_from_string(config->window, WINDOW_FUNCTION_BLACKMAN_HARRIS2);
                sinc_interpolation_type_t interp = sinc_interpolation_type_from_string(config->interpolation);
                async_sinc_resampler_t* res = async_sinc_resampler_create(
                    channels, input_rate, output_rate, (size_t)config->sinc_len, (size_t)config->oversampling_factor,
                    interp, wf, config->f_cutoff, config->has_f_cutoff, chunk_size, 1.1
                );
