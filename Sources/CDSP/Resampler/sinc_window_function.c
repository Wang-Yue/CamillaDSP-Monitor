...
window_function_t window_function_from_string(const char* str, window_function_t default_val) {
    ...
    if (strcmp(str, "BlackmanHarris") == 0) return WINDOW_FUNCTION_BLACKMAN_HARRIS;
    if (strcmp(str, "BlackmanHarris2") == 0) return WINDOW_FUNCTION_BLACKMAN_HARRIS2;
    return default_val;
}

const char* window_function_to_string(window_function_t wf) {
    switch (wf) {
        case WINDOW_FUNCTION_HANN: return "Hann";
        case WINDOW_FUNCTION_HANN2: return "Hann2";
        case WINDOW_FUNCTION_BLACKMAN: return "Blackman";
        case WINDOW_FUNCTION_BLACKMAN2: return "Blackman2";
        case WINDOW_FUNCTION_BLACKMAN_HARRIS: return "BlackmanHarris";
        case WINDOW_FUNCTION_BLACKMAN_HARRIS2: return "BlackmanHarris2";
        default: return "Hann";
    }
}
...
double window_value(window_function_t window, size_t i, size_t n) {
    ...
    switch (window) {
        ...
        case WINDOW_FUNCTION_BLACKMAN_HARRIS2: {
            double w = 0.35875 - 0.48829 * cos(arg2) + 0.14128 * cos(arg4) - 0.01168 * cos(arg6);
            return w * w;
        }
        default:
            return 1.0;
...
float calculate_cutoff_f32(size_t sinc_len, window_function_t window) {
    ...
    switch (window) {
        case WINDOW_FUNCTION_BLACKMAN_HARRIS:
            k1 = 8.041443677716476f; k2 = 55.9506779343387f; k3 = 898.0287985384213f;
            break;
        case WINDOW_FUNCTION_BLACKMAN_HARRIS2:
            k1 = 13.745202940783823f; k2 = 121.73532586374934f; k3 = 5964.163279612051f;
            break;
        case WINDOW_FUNCTION_BLACKMAN:
            k1 = 6.159598046201173f; k2 = 18.926415097606878f; k3 = 653.4247430458968f;
            break;
        case WINDOW_FUNCTION_BLACKMAN2:
            k1 = 9.506235102129398f; k2 = 79.13120634953742f; k3 = 1502.2316160588925f;
            break;
        case WINDOW_FUNCTION_HANN:
            k1 = 3.3481080887677166f; k2 = 10.106519434875038f; k3 = 78.96345249024414f;
            break;
        case WINDOW_FUNCTION_HANN2:
            k1 = 5.38751148378734f; k2 = 29.69451915489501f; k3 = 184.82117462266237f;
            break;
        default:
            k1 = 3.3481080887677166f; k2 = 10.106519434875038f; k3 = 78.96345249024414f;
            break;
...
double calculate_cutoff(size_t sinc_len, window_function_t window) {
    ...
    switch (window) {
        case WINDOW_FUNCTION_BLACKMAN_HARRIS:
            k1 = 8.041443677716476; k2 = 55.9506779343387; k3 = 898.0287985384213;
            break;
        case WINDOW_FUNCTION_BLACKMAN_HARRIS2:
            k1 = 13.745202940783823; k2 = 121.73532586374934; k3 = 5964.163279612051;
            break;
        case WINDOW_FUNCTION_BLACKMAN:
            k1 = 6.159598046201173; k2 = 18.926415097606878; k3 = 653.4247430458968;
            break;
        case WINDOW_FUNCTION_BLACKMAN2:
            k1 = 9.506235102129398; k2 = 79.13120634953742; k3 = 1502.2316160588925;
            break;
        case WINDOW_FUNCTION_HANN:
            k1 = 3.3481080887677166; k2 = 10.106519434875038; k3 = 78.96345249024414;
            break;
        case WINDOW_FUNCTION_HANN2:
            k1 = 5.38751148378734; k2 = 29.69451915489501; k3 = 184.82117462266237;
            break;
        default:
            k1 = 3.3481080887677166; k2 = 10.106519434875038; k3 = 78.96345249024414;
            break;
