...
void pipeline_update_parameters(pipeline_t* pipeline, const dsp_config_t* config, const char* const* filters, size_t filters_count, const char* const* mixers, size_t mixers_count, const char* const* processors, size_t processors_count);

/// Destroy and free the pipeline.
void pipeline_free(pipeline_t* pipeline);

static inline size_t pipeline_get_last_error_needed(const pipeline_t* pipeline) {
