...
void config_error_set(config_error_t* err, config_error_type_t type, const char* fmt, ...);
void config_error_description(const config_error_t* err, char* out_buf, size_t buf_len);
