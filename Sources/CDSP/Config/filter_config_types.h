 ...
 * @brief Configuration structures and validation functions for various audio filters.
 */
...
typedef enum {
  ...
  FILTER_TYPE_BIQUAD_COMBO,         /**< Combination of biquad filters (e.g., crossovers). */
 ...
 */
typedef enum {
  BIQUAD_COMBO_TYPE_BUTTERWORTH_HIGHPASS = 0,    /**< Butterworth high-pass filter. */
  BIQUAD_COMBO_TYPE_BUTTERWORTH_LOWPASS,     /**< Butterworth low-pass filter. */
  BIQUAD_COMBO_TYPE_LINKWITZ_RILEY_HIGHPASS, /**< Linkwitz-Riley high-pass filter. */
...
typedef struct {
  ...
  union {
    ...
    lookahead_limiter_parameters_t lookahead_limiter;   /**< Lookahead limiter parameters. */
