...
//
// Replaces the old `[[Double]]` ("array of arrays") chunk storage. The 2-D
...
// `Double` values up front and exposes per-channel `UnsafeMutableBufferPointer`
...
public final class AudioBuffers: @unchecked Sendable {
  ...
  public init(channels: Int, capacity: Int) {
    ...
    let storage = UnsafeMutablePointer<Double>.allocate(capacity: total)
