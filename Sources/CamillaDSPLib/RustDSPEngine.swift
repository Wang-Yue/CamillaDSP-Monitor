...
public actor CamillaDSPEngine {
  let engine: CamillaEngine = CamillaEngine()

  public init() {
    print("[CamillaDSPEngine] Initializing CamillaDSP library engine...")
  }
  ...
  public func getDeviceCapabilities(
    ...
    do {
      ...
      print("[CamillaDSPEngine] Failed to decode device capabilities: \(error)")
      return nil
    }
  }
